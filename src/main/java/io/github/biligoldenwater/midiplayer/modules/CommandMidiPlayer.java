    ...
    private static void sendHelpMessages(CommandSender sender,int helpLevel){
        switch (helpLevel){
            ...
            default:
                ...
                sender.sendMessage("Usage:/midiplayer play <index> [resourcePack] [useSoundStop]");
                sender.sendMessage("Play midi use index,and the default resource pack is vanilla resources.");
